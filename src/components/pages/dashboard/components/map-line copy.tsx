  ...
  return (
    <foreignObject width="100%">
      ...
      >
        ...
        />
        <path
          d="M2003.76 633.864H1975.41V662.21H2003.76V633.864Z"
          fill="#66FF33"
          stroke="#205867"
          stroke-width="5.33331"
          stroke-miterlimit="3"
        ...
        />
        <path
          d="M1461.59 948.346L1427.63 946.128"
          stroke="#FF0000"
          stroke-width="7.99997"
          stroke-miterlimit="3"
        />
        ...
        />
        <path
          d="M981.578 1153.54L958.507 1176.61"
          stroke="#FF0000"
          stroke-width="7.99997"
          stroke-miterlimit="3"
          stroke-linecap="round"
        ...
        />
        <path
          d="M1670.03 1185.68L1645.03 1215.44"
          stroke="#FF0000"
          stroke-width="7.99997"
          stroke-miterlimit="3"
        />
        ...
        />
        <path
          d="M1293.39 1107.05L1259.38 1115.75"
          stroke="#FF9900"
          stroke-width="7.99997"
          stroke-miterlimit="3"
        />
        ...
        />
        <path
          d="M1678.91 913.554C1687.26 913.554 1694.03 906.786 1694.03 898.436C1694.03 890.087 1687.26 883.318 1678.91 883.318C1670.56 883.318 1663.79 890.087 1663.79 898.436C1663.79 906.786 1670.56 913.554 1678.91 913.554Z"
          fill="#FF0000"
          stroke="#372277"
          stroke-width="5.33331"
          stroke-miterlimit="3"
        ...
        />
        <path
          d="M1990.82 579.062L2041.56 332.865"
          stroke="#262626"
        ...
        />
        <path
          d="M2007.55 647.097L2192.75 616.861"
          stroke="#262626"
          stroke-width="1.33333"
          stroke-miterlimit="3"
          stroke-linecap="square"
        ...
        />
        <path
          d="M1935.74 605.511L1625.82 329.917"
          stroke="#262626"
          stroke-width="1.33333"
          stroke-miterlimit="3"
          stroke-linecap="square"
        ...
        />
        <path
          d="M1667.4 881.434L1323.47 567.735"
          stroke="#262626"
          stroke-width="1.33333"
          stroke-miterlimit="3"
          stroke-linecap="square"
        ...
        />
        <path
          d="M1316.09 1031.67L1096.7 756.707"
          stroke="#262626"
          stroke-width="1.33333"
          stroke-miterlimit="3"
          stroke-linecap="square"
        ...
        />
        <path
          d="M1463.29 1157.33L1842.96 1329.3"
          stroke="#262626"
          stroke-width="1.33333"
          stroke-miterlimit="3"
          stroke-linecap="square"
        ...
        />
        <path
          d="M1423.26 1384.1L1531.32 1623.95"
          stroke="#262626"
          stroke-width="1.33333"
          stroke-miterlimit="3"
          stroke-linecap="square"
        ...
        />
        <path
          d="M940.212 1242.27L813.209 1463.49"
          stroke="#262626"
          stroke-width="1.33333"
          stroke-miterlimit="3"
          stroke-linecap="square"
        ...
        />
        {/* weather */}
        <foreignObject x="30" y="30" width="300" height="200">
          <div className="bg-gray-900 p-8 text-white rounded-xl text-3xl  flex flex-col gap-2 bg-opacity-80">
            <span className="font-semibold">Cuaca</span>
            <span>Coming Soon</span>
          </div>
        </foreignObject>
        <foreignObject x="350" y="30" width="300" height="200">
          <div className="bg-gray-900 p-8 text-white rounded-xl text-3xl  flex flex-col gap-2 bg-opacity-80">
            <span className="font-semibold">Cuaca</span>
            <span>Coming Soon</span>
          </div>
        ...
        <foreignObject x="2200" y="600" width="350" height="200">
        ...
        {/* gi */}
        <foreignObject x="1230" y="190" width="400" height="200">
          <div className="bg-indigo-400 p-4 border-8 border-white text-3xl  flex flex-col gap-2 bg-opacity-25">
            <span className="font-semibold">GI WAAI</span>
            <span>BEBAN: {roundNumber(data?.["GI WAAI"]?.pTotal)} MW</span>
            <span>TEGANGAN: {roundNumber(data?.["GI WAAI"]?.vAverage)} KV</span>
          </div>
        </foreignObject>
        <foreignObject x="1525" y="1600" width="400" height="200">
          <div className="bg-indigo-400 p-4 border-8 border-white text-3xl  flex flex-col gap-2 bg-opacity-25">
        ...
        <foreignObject x="690" y="1450" width="350" height="200">
          <div className="bg-indigo-400 p-4 border-8 border-white text-3xl  flex flex-col gap-2 bg-opacity-25">
        ...
        <foreignObject x="980" y="430" width="350" height="200">
          <div className="bg-indigo-400 p-4 border-8 border-white text-3xl  flex flex-col gap-2 bg-opacity-25">
            <span className="font-semibold">GI PASSO</span>
            <span>
              BEBAN:{" "}
              {roundNumber(
